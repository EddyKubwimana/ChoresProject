...
function displayAssignment($conn){
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>$date_due</td>";
        echo "<td>";
        echo "<button class='edit-button' onclick='editAssignment($id,\"$chorename\", \"$status\", \"$date_assigned\", \"$date_due\")'><img src='../asset/edit.png'></button>";
        echo "<button class='delete-button' onclick='deleteAssignment($id)'><img src='../asset/delete.png'></button>";
        echo "</td>";
        echo "</tr>";
    }
    $conn->close();
